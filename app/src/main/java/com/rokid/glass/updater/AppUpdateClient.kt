...
class AppUpdateClient(
    ...
    companion object {
        ...
        const val DEFAULT_CHECK_URL = "http://183.147.142.133:10203/api/v1/updates/check"
        const val DEFAULT_MANIFEST_URL = "http://183.147.142.133:10203/releases/latest/update.json"
